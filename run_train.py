...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--wandb_project", type=str, default="LRU", help="wandb project name"
    )
    parser.add_argument(
        "--wandb_entity",
        type=str,
    ...
    parser.add_argument("--r_min", type=float, default=0.4, help="|lambda|_min for LRU")
    parser.add_argument("--r_max", type=float, default=0.9, help="|lambda|_max for LRU")
    parser.add_argument("--A_init", type=str, default='glorot' , help="initialization method for A")
    ...
    # parser.add_argument("--bidirectional", type=str2bool, default=False, help="Type of normalization")
    ...
    parser.add_argument("--lr_factor", type=float, default=0.25, help="ssm lr = lr_factor * lr_base")
